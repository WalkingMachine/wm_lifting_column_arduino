...
void loop() 
{
  ...
  {
    actuator_state.data = STOP; // override topic if btn is used
  ...
  else if(actuator_state.data == UP)
  {
    actuator_state.data = UP; // override topic if btn is used
    digitalWrite(pin_m1, HIGH);
    digitalWrite(pin_m2, LOW);
  }
  else if(actuator_state.data == DOWN)
  {
    actuator_state.data = DOWN; // override topic if btn is used
    digitalWrite(pin_m1, LOW);
    digitalWrite(pin_m2, HIGH);
  }
  else
